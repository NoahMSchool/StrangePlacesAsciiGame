...
const ITEM = Object.freeze({
  ...
  STRANGEWALL: "STRANGEWALL",
  MANTLE_WALL: "MANTLE_WALL",
  TREE: "TREE",
  CAMPFIRE: "CAMPFIRE",
  ...
  KAON_LOCKED_DOOR: "KAON_LOCKED_DOOR",
  NOTE: "NOTE",
  ...
  LIBRARIAN: "LIBRARIAN",
  MUSEUM_MAN: "MUSEUM_MAN",
  MEDAL: "MEDAL",
  CAVE_GUARD: "CAVE_GUARD",
  ...
  DINOSAUR: "DINOSAUR",
  DINOSAUR_FOSSILS: "DINOSAUR_FOSSILS",
  GRATE: "GRATE",
  SEED: "SEED",
  CORN: "CORN",
  LAMP: "LAMP",
...
const ITEM_DEFS_BASE = {
  ...
  [ITEM.MANTLE_WALL]: {
    ...
    name: "Mantle Wall",
    emoji: "✨",
    synonyms: ["mantle wall", "orange wall", "spark wall"],
    examine: "An orange mineral wall flecked with glowing grains.",
    visible: false,
    portable: false,
    asciiTile: [
      "*.:;':*.:",
   ...
   [ITEM.STRANGEWALL]: {
    ...
    name: "WEIRDWALL",
    emoji: "*",
    synonyms: ["starngewall", "wierdwall"],
  ...
  [ITEM.KAON_LOCKED_DOOR]: {
    id: ITEM.KAON_LOCKED_DOOR,
    name: "Locked Door",
    emoji: "🔒",
    synonyms: ["door", "locked door", "kaon door", "particle door"],
    examine: "A locked particle door with a strange quantum lock.",
    roomDescExtra: "A locked door blocks the passage north.",
    visible: true,
    portable: false,
    asciiTile: [
      "|=======|",
 ...
 [ITEM.FRIDGE]: {
  ...
  [ITEM.PHYSICS_TEXTBOOK]: {
    id: ITEM.PHYSICS_TEXTBOOK,
    name: "Physics Textbook",
    emoji: "📘",
    synonyms: ["physics textbook", "textbook", "physics book", "blue book"],
    examine:
      "The charges of Up Down Strange Quarks and Strangeness Make The Key Particle With Strangeness -1 (You need to make a Kaon. And maybe an alpha particle later. Google it! This isn't a very good textbook)",
    visible: true,
    portable: false,
    takeText: "The librarian keeps it on her desk. Maybe she'd swap.",
    asciiTile: [
      " .-----. ",
      " | PHYS| ",
      " |BOOK | ",
  ...
  [ITEM.LIBRARIAN]: {
    ...
    name: "Librarian",
    emoji: "👩‍🏫",
    synonyms: ["librarian", "library keeper", "teacher"],
    examine: "A stern librarian watches you carefully over half-moon glasses.",
    visible: true,
    portable: false,
    asciiTile: [
      "  .---.  ",
 ...
 [ITEM.MEDAL]: {
  ...
  [ITEM.CAVE_GUARD]: {
    ...
    name: "Cave Guard",
    emoji: "🧌",
    synonyms: ["guard", "cave guard", "keeper", "sentinel"],
    examine: "A jittery cave guard blocks the passage, clutching a lantern.",
    visible: true,
    portable: false,
    asciiTile: [
      "  .---.  ",
 ...
 [ITEM.CHICKEN_IN_WEB]: {
  ...
  [ITEM.DINOSAUR_FOSSILS]: {
    id: ITEM.DINOSAUR_FOSSILS,
    name: "Dinosaur Fossils",
    emoji: "🦴",
    synonyms: ["dinosaur fossils", "fossils", "dinosaur bones", "fossil"],
    examine: "Ancient fossilized dinosaur bones, brittle but unmistakable.",
    visible: true,
    portable: true,
    asciiTile: [
      "  __.__  ",
  ...
  [ITEM.UPQUARK]: {
    ...
    name: "Up Quark",
    emoji: "⚛",
    synonyms: ["up", "upquark", "up quark"],
    examine: "A up quark. charge is +2/3 ",
    visible: true,
    portable: true,
    takeText: "Try hold it far away so you dont get ionised",
    eatText: "You should not have alpha particles inside your body",
  ...
  [ITEM.DOWNQUARK]: {
    ...
    name: "Down Quark",
    emoji: "⚛",
    synonyms: ["down", "downquark", "down quark"],
    examine: "A down quark. charge is -1/3 ",
    visible: true,
    portable: true,
    takeText: "Try hold it far away so you dont get ionised",
    eatText: "You should not have alpha particles inside your body",
  ...
  [ITEM.STRANGEQUARK]: {
    ...
    name: "Strange Quark",
    emoji: "⚛",
    synonyms: ["strange", "strange quark", "strangequark"],
    examine: "A strange quark indeed. charge -1/3, strangeness -1",
    visible: true,
    portable: true,
    takeText: "A strange discovery ",
    asciiTile: [
      "         ",
      "  /---\\  ",
      "|strange|",
  ...
  [ITEM.ANTISTRANGEQUARK]: {
    id: ITEM.ANTISTRANGEQUARK,
    name: "Anti Strange Quark",
    emoji: "⚛",
    synonyms: ["anti strange", "anti strange quark", "antistrangequark", "anti-strange quark"],
    examine: "A very not strange at all quark, charge +1/3, strangeness 1",
    visible: true,
    portable: true,
    takeText: "A finally something not strange ",
    asciiTile: [
      "         ",
      "  /NOT\\  ",
      "|strange|",
  ...
  [ITEM.HIGGSBOSON]: {
    ...
    name: "Higgs Boson",
    emoji: "⚛",
    synonyms: ["Higgs", "Higgs Boson", "Higgs Particle"],
    examine: "A particle discovered at CERN in 2012 at the Large Hadron COllider. Predicted by Peter Higs. Gives particles mass.",
    visible: true,
    portable: true,
    takeText: "Keep it safe",
    eatText: "Dont eat this incredible discovery",
    asciiTile: [
      "  _._._  ",
      " |HIGGS| ",
      " {     } ",
  ...
  [ITEM.KAON]: {
    ...
    name: "Kaon",
    emoji: "⚛",
    synonyms: ["kaon", "k meson", "k-meson"],
    examine: "A kaon: a meson with strangeness, fleeting and unstable.",
    visible: true,
    portable: true,
    takeText: "Sounds key.",
    eatText: "Sounds key",
  ...
  [ITEM.NEUTRON]: {
    ...
    name: "Neutron",
    emoji: "⚛",
    synonyms: ["neutron", "neutrons", "neurton"],
    examine: "A particle discovered at CERN in 2012 at the Large Hadron COllider. Predicted by Peter Higs. Gives particles mass.",
    visible: true,
    portable: true,
    takeText: "Keep it safe",
